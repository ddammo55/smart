...
export default function BannerText({title} : Props) {
    return (
        <div className="hidden lg:inline-block absolute top-0 left-0 w-full h-full">
           ...
           <Container className="flex h-full flex-col gap-y-6 justify-center">
                <motion.h2 
                    ...
                    className="text-7xl font-bold text-white">{title}
                </motion.h2>
                ...
                >
                    Stock up on sportswear and limited edition collectiorns on our <br/>
