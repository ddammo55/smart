    ...
    return (
        <div className='grid lg:grid-cols-2 gap-5 bg-white p-4 rounded-lg'>
            ...
            <div className='flex flex-col justify-center gap-y-10'>
                <div>
                    <p className='text-3xl font-semibold'>{product?.title}
                    </p>
                ...
                <div className='text-sm text-lightText flex flex-col'>
                    ...
                    <div className='flex items-center cursor-pointer group'>
                        <button className='bg-darkText text-slate-100 px-6 py-3 text-sm uppercase items-center justify-center border-r-[1px] border-r-slate-500'>add to cart</button>
                    ...
                    <p className='flex items-center gap-x-2 text-sm'>
                        <MdFavoriteBorder classNaem="text-xl" />Add to wishlist
                    </p>
            </div>
        </div>
    );
